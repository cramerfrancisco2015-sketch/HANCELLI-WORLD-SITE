...
export const translations: Record<Language, TranslationSchema> = {
  ...
  zh: {
    ...
    archiveDrop: {
      ...
      exploreStory: "探索品牌故事",
      waitlistCardTitle: "锁定您的 WAITLIST 席位",
      waitlistCardDesc: "留下您的邮箱、WhatsApp及心仪尺码，第一时间获取发售日期、库存动态与首发专属特惠。",
      btnWaitlist: "加入候补名单",
      btnSaveDrop: "订阅发售提醒",
      limitedTitle: "首发限定珍藏",
    ...
    lookbook: {
      ...
      waitlistTitle: "加入首发 DROP 候补名单",
      waitlistDesc: "抢先获取发售日期提醒、尺码库存动态及首发限定专属折扣优惠。",
      labelName: "姓名",
